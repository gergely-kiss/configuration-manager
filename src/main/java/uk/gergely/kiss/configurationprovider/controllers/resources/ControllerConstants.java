...
public class ControllerConstants {
    ...
    public static final String RETURN_ALL_PROPERTY = "return_all_property";
    public static final String RETURN_ALL_APP_WITH_ALL_PROPERTY = "return_all_app_with_all_property";
